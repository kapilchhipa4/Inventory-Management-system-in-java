...
public class Invoice extends JPanel {
	...
	public Invoice() {
		...
		lblProductId.setBounds(88, 133, 80, 23);
		add(lblProductId);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String query = "insert into sale values ('"+date+"','" +id+"','"+str[1]+"','"+fp+"')";
				try
				{
				...
				{
					System.out.println(e+ "error in sales");
				}
		...
		btnclear.setBounds(550, 411, 89, 52);
		add(btnclear);
		gtotal = new JLabel("");
